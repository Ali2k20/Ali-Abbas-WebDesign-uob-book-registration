...
<html lang="en">
    ...
    require("conn.php");
    session_start();
    // this code is to find the rooms the isn't booked 
    ...
    <td>
        <button class="edit-btn" type="button" onclick="openEditRoomModal('<?php echo $r['room_id']; ?> ')">Edit</button>
                ...
                <button type="submit" class="delete-btn" 
                   onclick="return confirm('Are you sure you want to delete this room?') ">Delete</button></form>
                    </td>
                </tr>
...
<script>
   function openEditRoomModal($roomid) {
    ...
    // If roomPic is available, set it as the current image in the modal (optional)
